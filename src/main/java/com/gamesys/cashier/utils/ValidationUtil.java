...
public class ValidationUtil {
    ...
    public static boolean isISOFormat(String date) {
        return (Optional.ofNullable(date).isPresent() ? date : EMPTY_STRING).matches(ISO_DATE_REGEX);
    }
    ...
    public static boolean isValidUsername(String userName) {
        return (Optional.ofNullable(userName).isPresent() ? userName : EMPTY_STRING).matches(ALPHANUMERIC_REGEX);
    }
    ...
    public static boolean isValidPassword(String password) {
        return (Optional.ofNullable(password).isPresent() ? password : EMPTY_STRING).matches(PASSWORD_REGEX);
    }
